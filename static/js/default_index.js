...
var app = function () {
    ...
    self.calculate_gps = function () {
        ...
        self.vue.goldpersecond += self.vue.tribute;
    }
    ...
    self.get_village = function () {
        $.getJSON(get_village_url, function (data) {
            ...
            self.vue.tribute = village.tribute;
        })
    }

    self.get_villages = function () {
        $.getJSON(get_other_villages_url, function (data) {
            unlucky_village = JSON.parse(data.unlucky_village);
            if (self.vue.attacking) {
                if ((self.vue.weapons + self.vue.goblins) < (unlucky_village.goblins + unlucky_village.weapons)) {
                    self.vue.victory = false;
                }
                else {
                    self.vue.victory = true;
                    ...
                    self.vue.tribute += self.vue.attacking_gps;
                    self.calculate_gps();
                }
    ...
    self.vue = new Vue({
        ...
        data: {
            ...
            shop: [{
                item_name: "Farm",
                price: 10,
                description: "Grows more (vegetable you don't like) than you can imagine!",
                amount: 0,
                gold_per_sec: .2,
                img: "/goblinvillage/static/images/farm.png"
            },
                {
                    item_name: "General Store",
                    price: 100,
                    description: "Sells generals",
                    amount: 0,
                    gold_per_sec: 3,
                    img: "/goblinvillage/static/images/store.png"
                },
                {
                    item_name: "Tailor's Market",
                    price: 1000,
                    description: "Stocks a vast variety of products, but only one outfit ever gets bought",
                    amount: 0,
                    gold_per_sec: 35,
                    img: "/goblinvillage/static/images/clothes.png"
                },
                {
                    item_name: "Gemsmith",
                    price: 10000,
                    description: "Counterfeit glass",
                    amount: 0,
                    gold_per_sec: 400,
                    img: "/goblinvillage/static/images/gem.png"
                },
                {
                    item_name: "Oil Well",
                    price: 100000,
                    description: "Oil is like an energy drink to goblins",
                    amount: 0,
                    gold_per_sec: 4250,
                    img: "/goblinvillage/static/images/oil.png"
                },
                {
                    item_name: "Castle",
                    price: 1000000,
                    description: "More like a playground than a defensive structure",
                    amount: 0,
                    gold_per_sec: 45000,
                    img: "/goblinvillage/static/images/castle.png"
                }],
            mines: [{
                item_name: "Copper Mine",
                price: 20,
                description: "When it comes to goblins, 'mine' has a double meaning",
                amount: 0,
                gold_per_click: 1,
                img: "/goblinvillage/static/images/coppermine.png"
            },
                {
                    item_name: "Iron Mine",
                    price: 200,
                    description: "Iron is too difficult to work with, so goblins just use the rocks in this mine",
                    amount: 0,
                    gold_per_click: 10,
                    img: "/goblinvillage/static/images/ironmine.png"
                },
                {
                    item_name: "Lumber Mine",
                    price: 2000,
                    description: "Requires specialty pickaxes",
                    amount: 0,
                    gold_per_click: 100,
                    img: "/goblinvillage/static/images/tree.png"
                },
                {
                    item_name: "Gold Mine",
                    price: 20000,
                    description: "Creates gold, like all the other stuff here",
                    amount: 0,
                    gold_per_click: 1000,
                    img: "/goblinvillage/static/images/goldmine.png"
                },
                {
                    item_name: "Diamond Mine",
                    price: 200000,
                    description: "It's crystal clear that this mine is a gem in the rough, these diamonds rock!",
                    amount: 0,
                    gold_per_click: 10000,
                    img: "/goblinvillage/static/images/diamondmine.png"
                }],
            attacking: false,
